 ...
 */
final class Version20230614162431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient CHANGE id_ingredient id INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE ingredient ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient MODIFY id INT NOT NULL');
        $this->addSql('DROP INDEX `PRIMARY` ON ingredient');
        $this->addSql('ALTER TABLE ingredient CHANGE id id_ingredient INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE ingredient ADD PRIMARY KEY (id_ingredient)');
    }
}
